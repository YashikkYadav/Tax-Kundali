    ...
    <main className="bg-gray-50 min-h-screen">
      ...
      >
        <div className="max-w-6xl mx-auto px-6 text-left">
          <motion.h1 className="text-5xl font-extrabold text-white mb-3 leading-tight" variants={fadeInUp}>
            About Tax Kundali
          </motion.h1>
          <motion.p className="text-xl text-blue-100 max-w-2xl" variants={fadeInUp}>
      ...
      <motion.section
        ...
        variants={fadeIn}
      >
        <motion.div className="flex flex-col md:flex-row gap-12 items-center md:items-stretch" variants={staggerContainer}>
          {/* Founder Card */}
          <motion.div className="w-full md:w-1/3 flex justify-center shadow-base" variants={fadeInLeft}>
            <motion.div className="bg-gradient-to-b from-[#F0F7FF] to-white rounded-3xl shadow-xl border border-blue-100 flex flex-col items-center p-0 w-full max-w-xs overflow-hidden" variants={scaleIn}>
              ...
              <div className="w-full flex flex-col items-center px-6 pb-8 pt-4">
                <motion.h2 className="text-2xl font-bold text-gray-900 mb-1 mt-2 text-center" variants={fadeInUp}>
                  CA Vikash Saini
                </motion.h2>
                <motion.p className="text-[#0089FF] font-medium mb-2 text-center" variants={fadeInUp}>
                  Chartered Accountant
                </motion.p>
                <motion.p className="text-gray-500 text-center mb-4 text-sm" variants={fadeInUp}>
                  Helping you simplify tax, compliance, and business growth.
                </motion.p>
                <motion.div className="flex justify-center gap-6 mb-6 text-gray-500" variants={fadeInUp}>
          ...
          {/* Divider for desktop */}
          <motion.div className="hidden md:block w-px bg-gray-200 mx-4" variants={fadeInUp}></motion.div>

          {/* About Content */}
          <motion.div className="w-full md:w-2/3 flex flex-col justify-center" variants={fadeInUp}>
            <motion.h3 className="text-3xl font-bold text-gray-900 mb-6" variants={fadeInUp}>
              Your Trusted Partner in Finance & Taxation
            </motion.h3>
            <motion.p className="text-gray-700 mb-5 text-lg" variants={fadeInUp}>
            ...
            <motion.p className="text-gray-700 mb-8 text-lg" variants={fadeInUp}>
      ...
      <motion.section
        ...
        variants={fadeIn}
      >
        <motion.h4 className="text-2xl font-bold text-gray-900 mb-10 text-center" variants={fadeInUp}>
          Our Core Services
        </motion.h4>
        <motion.div className="flex flex-wrap  justify-center gap-8" variants={staggerContainer}>
